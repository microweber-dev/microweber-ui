...
<main>
        ...
        <div class="card-header">
            ...
            <div>
                <nav class="nav btn-hover-style-2">
                    <a class="btn btn-outline-secondary btn-sm justify-content-center active" data-bg-toggle="tab" href="#stat-daily">Daily</a>
                    <a class="btn btn-outline-secondary btn-sm justify-content-center mx-2" data-bg-toggle="tab" href="#stat-weekly">Weekly</a>
                    <a class="btn btn-outline-secondary btn-sm justify-content-center mr-2" data-bg-toggle="tab" href="#stat-monthly">Monthly</a>
                    <a class="btn btn-outline-secondary btn-sm justify-content-center" data-bg-toggle="tab" href="#stat-yearly">Yearly</a>
                </nav>
            </div>
        </div>
        <div class="card-body">
    ...
    <div class="card style-1 mb-3">
        ...
        <div class="card-body">
            ...
            <div class="card mb-2 not-collapsed-border collapsed card-success card-order-holder" data-bg-toggle="collapse" data-target="#collapse-3" aria-expanded="false" aria-controls="collapseExample">
                <div class="card-body">
                    <div class="row">
            ...
            <div class="card mb-2 not-collapsed-border collapsed card-danger card-order-holder" data-bg-toggle="collapse" data-target="#collapse-4" aria-expanded="false" aria-controls="collapseExample">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="row align-items-center">
            ...
            <div class="card mb-2 not-collapsed-border collapsed card-order-holder bg-silver" data-bg-toggle="collapse" data-target="#collapse-1" aria-expanded="false" aria-controls="collapseExample">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="row align-items-center">
            ...
            <div class="card mb-2 not-collapsed-border collapsed card-order-holder bg-silver" data-bg-toggle="collapse" data-target="#collapse-2" aria-expanded="false" aria-controls="collapseExample">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="row align-items-center">
    ...
    <div class="card style-1 mb-3">
        ...
        <div class="card-body">
            <div class="card mb-2 not-collapsed-border collapsed bg-silver" data-bg-toggle="collapse" data-target="#comments-1" aria-expanded="false" aria-controls="collapseExample">
                <div class="card-body">
                    <div class="row align-items-center">
    ...
    <div class="card style-1 mb-3 card-message-holder">
        ...
        <div class="card-body">
            <div class="card mb-2 not-collapsed-border collapsed bg-silver" data-bg-toggle="collapse" data-target="#message-1" aria-expanded="false" aria-controls="collapseExample">
                <div class="card-body">
                    <div class="row align-items-center">
