...
<div class="bg-primary py-1 position-sticky sticky-top">
    <ul class="nav p-3" id="myTab" role="tablist">
        ...
        <li class="mx-1"><a class="btn btn-info" data-bg-toggle="tab" href="#navigations" role="tab"
                            aria-controls="navigations" aria-selected="true">Navigations</a></li>
        <li class="mx-1"><a class="btn btn-info" data-bg-toggle="tab" href="#buttons" role="tab" aria-controls="buttons"
                            aria-selected="false">Buttons</a></li>
        <li class="mx-1"><a class="btn btn-info" data-bg-toggle="tab" href="#badges" role="tab" aria-controls="badges"
                            aria-selected="true">Badges</a></li>
        <li class="mx-1"><a class="btn btn-info" data-bg-toggle="tab" href="#progress" role="tab" aria-controls="progress"
                            aria-selected="false">Progress bars</a></li>
        <li class="mx-1"><a class="btn btn-info" data-bg-toggle="tab" href="#typography" role="tab"
                            aria-controls="typography" aria-selected="false">Typography</a></li>
        <li class="mx-1"><a class="btn btn-info" data-bg-toggle="tab" href="#tables" role="tab" aria-controls="tables"
                            aria-selected="false">Tables</a></li>
        <li class="mx-1"><a class="btn btn-info" data-bg-toggle="tab" href="#forms" role="tab" aria-controls="tables"
                            aria-selected="false">Forms</a></li>
        <li class="mx-1"><a class="btn btn-info" data-bg-toggle="tab" href="#cards" role="tab" aria-controls="cards"
                            aria-selected="false">Cards</a></li>
        <li class="mx-1"><a class="btn btn-info" data-bg-toggle="tab" href="#tabs" role="tab" aria-controls="tabs"
                            aria-selected="false">Tabs</a></li>
        <li class="mx-1"><a class="btn btn-info" data-bg-toggle="tab" href="#others-tab" role="tab" aria-controls="other"
                        ...
                        <div class="col-lg-12">
                            <div class="bs-component my-3">
                                <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
                                    ...
                                    <button class="navbar-toggler" type="button" data-bg-toggle="collapse"
                ...
                <div class="container-fluid">
                    <div class="row d-flex justify-content-center">
                            ...
                            <div class="buttons-standarts">
                                ...
                                <div class="bs-component my-3">
                                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                        ...
                                        <div class="btn-group" role="group">
                                            <button id="btnGroupDrop1" type="button"
                                                    class="btn btn-primary dropdown-toggle" data-bg-toggle="dropdown"
                                    ...
                                    <div class="btn-group d-none" role="group"
                                        ...
                                        <div class="btn-group" role="group">
                                            <button id="btnGroupDrop5" type="button"
                                                    class="btn btn-secondary dropdown-toggle" data-bg-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false"></button>
                                    ...
                                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                        ...
                                        <div class="btn-group" role="group">
                                            <button id="btnGroupDrop2" type="button"
                                                    class="btn btn-success dropdown-toggle" data-bg-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false"></button>
                                    ...
                                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                        ...
                                        <div class="btn-group" role="group">
                                            <button id="btnGroupDrop3" type="button"
                                                    class="btn btn-info dropdown-toggle" data-bg-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false"></button>
                                    ...
                                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                        <button type="button" class="btn btn-warning">Warning</button>
                                        <div class="btn-group" role="group">
                                            <button id="btnGroupDrop6" type="button"
                                                    class="btn btn-warning dropdown-toggle" data-bg-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false"></button>
                                    ...
                                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                        ...
                                        <div class="btn-group" role="group">
                                            <button id="btnGroupDrop4" type="button"
                                                    class="btn btn-danger dropdown-toggle" data-bg-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false"></button>
                        ...
                        <div class="col-xl-3 text-center">
                            ...
                            <p class="bs-component my-3">
                                <button type="button" class="btn btn-primary btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-secondary btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-success btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-info btn-icon"><i class="mdi mdi-cards-heart"></i>
                                </button>
                                <button type="button" class="btn btn-warning btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-danger btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-link btn-icon"><i class="mdi mdi-cards-heart"></i>
                                </button>
                            </p>

                            <p class="bs-component my-3">
                                <button type="button" class="btn btn-primary disabled btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-secondary disabled btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-success disabled btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-info disabled btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-warning disabled btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-danger disabled btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-link disabled btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                            </p>
                            ...
                            <p class="bs-component my-3">
                                <button type="button" class="btn btn-outline-primary btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-outline-secondary btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-outline-success btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-outline-info btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                            ...
                            <p class="bs-component my-3">
                                <button type="button" class="btn btn-primary btn-rounded btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-secondary btn-rounded btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-success btn-rounded btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-info btn-rounded btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                ...
                                <button type="button" class="btn btn-danger btn-rounded btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-link btn-rounded btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                            </p>

                            <p class="bs-component my-3">
                                <button type="button" class="btn btn-outline-primary btn-rounded btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-outline-secondary btn-rounded btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-outline-success btn-rounded btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-outline-info btn-rounded btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-outline-warning btn-rounded btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-outline-danger btn-rounded btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                                <button type="button" class="btn btn-link btn-rounded btn-icon"><i
                                            class="mdi mdi-cards-heart"></i></button>
                            </p>
                        ...
                        <div class="col-xl-4">
                            <div class="buttons-with-icons">
                                ...
                                <p class="bs-component my-3">
                                    <button type="button" class="btn btn-primary icon-left"><i
                                                class="mdi mdi-account-edit"></i> Primary
                                    </button>
                                    <button type="button" class="btn btn-success icon-left"><i class="mdi mdi-plus"></i>
                                        Success
                                    </button>
                                    <button type="button" class="btn btn-info icon-left"><i
                                                class="mdi mdi-information-variant"></i> Info
                                    </button>
                                    <button type="button" class="btn btn-warning icon-right">Warning <i
                                                class="mdi mdi-alert"></i></button>
                                    <button type="button" class="btn btn-danger icon-right">Danger <i
                                                class="mdi mdi-close-octagon"></i></button>
                                    <button type="button" class="btn btn-link icon-left"><i class="mdi mdi-link"></i>
                                        Link
                                    </button>
                                </p>

                                <p class="bs-component my-3">
                                    <button type="button" class="btn btn-primary disabled icon-left"><i
                                                class="mdi mdi-account-edit"></i> Primary
                                    </button>
                                    <button type="button" class="btn btn-success disabled icon-left"><i
                                                class="mdi mdi-plus"></i> Success
                                    </button>
                                    <button type="button" class="btn btn-info disabled icon-left"><i
                                                class="mdi mdi-information-variant"></i> Info
                                    </button>
                                    <button type="button" class="btn btn-warning disabled icon-right">Warning <i
                                                class="mdi mdi-alert"></i></button>
                                    <button type="button" class="btn btn-danger disabled icon-right">Danger <i
                                                class="mdi mdi-close-octagon"></i></button>
                                    <button type="button" class="btn btn-link disabled icon-left"><i
                                                class="mdi mdi-link"></i> Link
                                    </button>
                                </p>

                                <p class="bs-component my-3">
                                    <button type="button" class="btn btn-outline-primary icon-left"><i
                                                class="mdi mdi-account-edit"></i> Primary
                                    </button>
                                    <button type="button" class="btn btn-outline-success icon-left"><i
                                                class="mdi mdi-plus"></i> Success
                                    </button>
                                    <button type="button" class="btn btn-outline-info icon-left"><i
                                                class="mdi mdi-information-variant"></i> Info
                                    </button>
                                    <button type="button" class="btn btn-outline-warning icon-right">Warning <i
                                                class="mdi mdi-alert"></i></button>
                                    <button type="button" class="btn btn-outline-danger icon-right">Danger <i
                                                class="mdi mdi-close-octagon"></i></button>
                                    <button type="button" class="btn btn-link icon-left"><i class="mdi mdi-link"></i>
                                        Link
                                    </button>
                                ...
                                <p class="bs-component my-3">
                                    <button type="button" class="btn btn-primary btn-rounded icon-left"><i
                                                class="mdi mdi-account-edit"></i> Primary
                                    </button>
                                    <button type="button" class="btn btn-success btn-rounded icon-left"><i
                                                class="mdi mdi-plus"></i> Success
                                    </button>
                                    <button type="button" class="btn btn-info btn-rounded icon-left"><i
                                                class="mdi mdi-information-variant"></i> Info
                                    </button>
                                    <button type="button" class="btn btn-warning btn-rounded icon-right">Warning <i
                                                class="mdi mdi-alert"></i></button>
                                    <button type="button" class="btn btn-danger btn-rounded icon-right">Danger <i
                                                class="mdi mdi-close-octagon"></i></button>
                                    <button type="button" class="btn btn-link btn-rounded icon-left"><i
                                                class="mdi mdi-link"></i> Link
                                    </button>
                                </p>

                                <div class="bs-component my-3">
                                    <button type="button" class="btn btn-primary btn-lg icon-left"><i
                                                class="mdi mdi-arrow-right"></i> Large button
                                    </button>
                                    <button type="button" class="btn btn-primary icon-left"><i
                                                class="mdi mdi-arrow-right"></i> Default button
                                    </button>
                                    <button type="button" class="btn btn-primary btn-sm icon-left"><i
                                                class="mdi mdi-arrow-right"></i> Small button
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-xl-6">
                            <div class="buttons-all-types">
                                <p class="bs-component my-3">
                                    ...
                                    <button type="button" class="btn btn-primary icon-left btn-sm"><i
                                                class="mdi mdi-account-edit"></i> Primary
                                    </button>
                                    <button type="button" class="btn btn-primary btn-icon btn-sm"><i
                                                class="mdi mdi-cards-heart"></i></button>
                                    <button type="button" class="btn btn-outline-primary btn-icon btn-sm"><i
                                                class="mdi mdi-cards-heart"></i></button>
                                    <button type="button" class="btn btn-primary btn-rounded btn-icon btn-sm"><i
                                                class="mdi mdi-cards-heart"></i></button>
                                    <button type="button" class="btn btn-outline-primary btn-rounded btn-icon btn-sm"><i
                                                class="mdi mdi-cards-heart"></i></button>
                                    <button type="button" class="btn btn-link btn-rounded btn-icon btn-sm"><i
                                                class="mdi mdi-cards-heart"></i></button>
                                </p>
                                ...
                                <p class="bs-component my-3">
                                    ...
                                    <button type="button" class="btn btn-primary icon-left btn-lg"><i
                                                class="mdi mdi-account-edit"></i> Primary
                                    </button>
                                    <button type="button" class="btn btn-primary btn-icon btn-lg"><i
                                                class="mdi mdi-cards-heart"></i></button>
                                    <button type="button" class="btn btn-outline-primary btn-icon btn-lg"><i
                                                class="mdi mdi-cards-heart"></i></button>
                                    <button type="button" class="btn btn-primary btn-rounded btn-icon btn-lg"><i
                                                class="mdi mdi-cards-heart"></i></button>
                                    <button type="button" class="btn btn-outline-primary btn-rounded btn-icon btn-lg"><i
                                                class="mdi mdi-cards-heart"></i></button>
                                    <button type="button" class="btn btn-link btn-rounded btn-icon btn-lg"><i
                                                class="mdi mdi-cards-heart"></i></button>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-5">
                            ...
                            <div class="bs-component my-3">
                                <div class="btn-group btn-group-toggle" data-bg-toggle="buttons">
                                ...
                                <div class="btn-group btn-group-toggle btn-hover-style-1" data-bg-toggle="buttons">
                                    <label class="btn btn-outline-secondary active">
                                        <input type="checkbox" checked autocomplete="off"> Active
                                    </label>
                                    <label class="btn btn-outline-secondary">
                            ...
                            <div class="bs-component my-3">
                                ...
                                <div class="btn-group btn-group-toggle" data-bg-toggle="buttons">
                                    <label class="btn btn-outline-secondary active">
                                        <input type="radio" name="options" id="xoption1" autocomplete="off" checked>
                                        Active
                                    </label>
                                    <label class="btn btn-outline-secondary">
                                ...
                                <div class="btn-group btn-group-toggle btn-hover-style-1" data-bg-toggle="buttons">
                                    <label class="btn btn-outline-secondary active">
                                        <input type="radio" name="options" id="yoption1" autocomplete="off" checked>
                                        Active
                                    </label>
                                    <label class="btn btn-outline-secondary">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-5">
                            <div class="my-3">
                                <button type="button" class="btn btn-outline-secondary icon-left btn-sm"><i
                                            class="mdi mdi-cart"></i> Notifications <span
                                            class="badge badge-success badge-pill ml-3">4</span></button>
                                <button type="button" class="btn btn-outline-secondary icon-left"><i
                                            class="mdi mdi-cart"></i> Notifications <span
                                            class="badge badge-success badge-pill ml-3">4</span></button>
                                <button type="button" class="btn btn-outline-secondary icon-left btn-lg"><i
                                            class="mdi mdi-cart"></i> Notifications <span
                                            class="badge badge-success badge-pill ml-3">4</span></button>
                            </div>
                            ...
                            <div class="my-3">
                                <button class="btn btn-primary btn-sm" type="button" disabled><i
                                            class="spinner-border spinner-border-sm mr-2" aria-hidden="true"></i>
                                    Loading...
                                </button>
                                &nbsp; &nbsp;
                            ...
                            <div class="my-3">
                                <div class="btn-group tag tag-xs">
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm btn-icon"><i
                                ...
                                &nbsp; &nbsp;
                                <div class="btn-group tag">
                                    <span class="btn btn-primary icon-left no-hover"><i
                                                class="mdi mdi-tag"></i> Tag</span>
                                    <button type="button" class="btn btn-primary btn-icon"><i class="mdi mdi-close"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="my-3">
                                <div class="bs-component my-3">
                                    <div class="btn-group btn-group-toggle">
                                        <button type="button" class="btn btn-outline-secondary icon-left btn-sm"><i
                                                    class="mdi mdi-thumb-up text-silver"></i> <strong>10</strong>
                                        </button>
                                        <button type="button" class="btn btn-outline-secondary icon-left btn-sm"><i
                                                    class="mdi mdi-thumb-down text-silver"></i> <strong>6</strong>
                                        </button>
                                    </div>
                                    &nbsp; &nbsp;
                                    <div class="btn-group btn-group-toggle">
                                        <button type="button" class="btn btn-outline-secondary text-s icon-left"><i
                                                    class="mdi mdi-thumb-up text-silver"></i> <strong>10</strong>
                                        </button>
                                        <button type="button" class="btn btn-outline-secondary icon-left"><i
                                                    class="mdi mdi-thumb-down text-silver"></i> <strong>6</strong>
                            ...
                            <div class="my-3">
                                <div class="bs-component my-3">
                                    <div class="d-inline-block">
                                        <button type="button" class="btn text-silver btn-link btn-icon btn-sm"><i
                            ...
                            <div class="my-3">
                                <div class="btn-group btn-group-quantity">
                                    <button type="button" class="btn btn-primary btn-sm btn-icon btn-minus"><i
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm btn-icon btn-plus"><i
                                ...
                                &nbsp; &nbsp;
                                <div class="btn-group btn-group-quantity">
                                    <button type="button" class="btn btn-outline-secondary btn-sm btn-icon btn-minus"><i
                                                class="mdi mdi-minus"></i></button>
                                    <span class="btn btn-outline-secondary btn-sm icon-left no-hover qty-holder">
                                                <input type="text" value="10"/>
                                            </span>
                                    <button type="button" class="btn btn-outline-secondary btn-sm btn-icon btn-plus"><i
                                                class="mdi mdi-plus"></i></button>
                                </div>
                                &nbsp; &nbsp;
                                <div class="btn-group btn-group-rounded btn-group-quantity">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="bs-component my-3">
                                <div class="progress">
                                    <div class="progress-bar my-1" role="progressbar" style="width: 15%"
                                         aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                                    <div class="progress-bar bg-success my-1" role="progressbar" style="width: 30%"
                                         aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                    <div class="progress-bar bg-info my-1" role="progressbar" style="width: 20%"
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="bs-component">
                                ...
                                <p class="lead">This is Lead text. Vivamus sagittis lacus vel augue laoreet rutrum
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small id="fileHelp" class="form-text text-muted">This is some placeholder
                                                block-level help text for the above input. It's a bit lighter and easily
                                        ...
                                        <fieldset class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 position-relative">
                                                        <input type="text" class="js-slider" name="my_range" value=""
                                                               data-min="10" data-max="100" data-type="single"
                                                               data-step="1" data-grid="true"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="js-range">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 position-relative">
                                                        <input type="text" class="js-slider" name="my_range" value=""
                                                               data-min="10" data-max="100" data-type="double"
                                                               data-step="1" data-grid="false"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </fieldset>
                        ...
                        <div class="col-lg-4 offset-lg-1">
                            ...
                            <form class="bs-component">
                                ...
                                <div class="form-inline">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-icon mb-2"><i
                    ...
                    <div class="mt-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 my-1">
                                <label>Badges</label>
                                <select class="selectpicker">
                                    <option data-content="<span class='badge badge-success'>Relish</span>">Relish
                                    </option>
                                    <option>Mustard</option>
                                    <option>Ketchup</option>
                                    <option>Barbecue</option>
                                    ...
                                    <div class="input-group mb-3 prepend-transparent append-transparent input-group-quantity">
                                        ...
                                        <div class="input-group-append">
                                            <div class="input-group-text plus-minus-holder">
                                                <button type="button" class="plus"><i class="mdi mdi-menu-up"></i>
                                                </button>
                                                <button type="button" class="minus"><i class="mdi mdi-menu-down"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-3 my-1">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3 prepend-transparent append-transparent">
                                        ...
                                        <input type="text" class="form-control" value="0.00"/>
                                        <div class="input-group-append">
                                            <span class="input-group-text" data-bg-toggle="tooltip"
                        ...
                        <div class="col-12">
                            <div class="bs-component">
                                <nav class="nav nav-pills nav-justified btn-group btn-group-toggle btn-hover-style-1">
                                    <a class="btn btn-outline-secondary btn-sm justify-content-center active"
                                       data-bg-toggle="tab" href="#home">White</a>
                                    <a class="btn btn-outline-secondary btn-sm justify-content-center" data-bg-toggle="tab"
                                       href="#profile">Yellow</a>
                                    <a class="btn btn-outline-secondary btn-sm justify-content-center" data-bg-toggle="tab"
                                       href="#other">Red</a>
                                    <a class="btn btn-outline-secondary btn-sm justify-content-center" data-bg-toggle="tab"
                                       href="#other">Blue</a>
                                ...
                                <br/>
                                <nav class="nav nav-pills nav-justified btn-group btn-group-toggle btn-hover-style-1">
                                    <a class="btn btn-outline-secondary justify-content-center active" data-bg-toggle="tab"
                                       href="#home">White</a>
                                    <a class="btn btn-outline-secondary justify-content-center" data-bg-toggle="tab"
                                       href="#profile">Yellow</a>
                                    <a class="btn btn-outline-secondary justify-content-center" data-bg-toggle="tab"
                                       href="#other">Red</a>
                                    <a class="btn btn-outline-secondary justify-content-center" data-bg-toggle="tab"
                                ...
                                <div id="myTabContent" class="tab-content py-3">
                                    <div class="tab-pane fade show active" id="home">
                                        <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt
                                            ...
                                            dreamcatcher synth. Cosbysweater
                                    ...
                                    <div class="tab-pane fade" id="profile">
                                        <p>Food truck fixie locavore, accusamus mcsweeney's marfa nulla single-origin
                                            ...
                                            enim craftbeer mlkshk aliquip jean shorts ullamco ad vinyl cillum PBR. Homo
                                    ...
                                    <div class="tab-pane fade" id="other">
                                        <p>Etsy mixtape wayfarers, ethical wes anderson tofu before they sold out
                                            ...
                                            locavore carles etsy salvia banksyhoodie
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="bs-component">
                                    <div class="alert alert-dismissible alert-warning">
                                        ...
                                        <p class="mb-0">Best check yo self, you're not looking too good. Nulla vitae
                                            elit libero, a pharetra augue. Praesent commodo cursus magna, <a href="#"
                            ...
                            <div class="col-lg-4">
                                <div class="bs-component">
                                    <div class="list-group">
                                        ...
                                        <a href="#" class="list-group-item list-group-item-action disabled">Morbi leo
                                            risus
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="bs-component">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bg-toggle="modal"
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="bs-component" style="margin-bottom: 3em;">
                                    <button type="button" class="btn btn-secondary" title="Popover Title"
                                            data-container="body" data-bg-toggle="popover" data-placement="left"
                                            data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                        Left
                                    </button>

                                    <button type="button" class="btn btn-secondary" title="Popover Title"
                                            data-container="body" data-bg-toggle="popover" data-placement="top"
                                            data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Top
                                    </button>

                                    <button type="button" class="btn btn-secondary" title="Popover Title"
                                            data-container="body" data-bg-toggle="popover" data-placement="bottom"
                                            data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                        Bottom
                                    </button>

                                    <button type="button" class="btn btn-secondary" title="Popover Title"
                                            data-container="body" data-bg-toggle="popover" data-placement="right"
                                            data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                        Right
                                    </button>
                                </div>
                                <h2>Tooltips</h2>
                                <div class="bs-component" style="margin-bottom: 3em;">
                                    <button type="button" class="btn btn-secondary" data-bg-toggle="tooltip"
