        ...
        <div class="card-body">
            ...
            <div class="timeline">
                ...
                <div class="row timeline-event">
                    ...
                    <div class="col">
                        <div class="card mb-2 not-collapsed-border collapsed card-bubble card-order-holder bg-silver" data-bg-toggle="collapse" data-target="#collapse-1" aria-expanded="false" aria-controls="collapseExample">
                            <div class="card-body">
                                <div class="row">
                ...
                <div class="row timeline-event">
                    ...
                    <div class="col">
                        <div class="card mb-2 not-collapsed-border collapsed card-message-holder card-bubble bg-silver" data-bg-toggle="collapse" data-target="#message-1" aria-expanded="false" aria-controls="collapseExample">
                            <div class="card-body">
                ...
                <div class="row timeline-event">
                    ...
                    <div class="col">
                        <div class="card mb-2 not-collapsed-border collapsed card-bubble bg-silver" data-bg-toggle="collapse" data-target="#comments-1" aria-expanded="false" aria-controls="collapseExample">
                            <div class="card-body">
                                <div class="row align-items-center mb-3">
                                    <div class="col text-left">
